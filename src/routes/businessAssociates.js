...
const c = crudFor('business_associates', [
  'business_type','company_name','poc_name','contact_number','mail_id',
  'communication_address','pin_code','operating_zone','employee_strength',
  'gst_details','projects_handled','credit_period','specialization','is_active'
]);
